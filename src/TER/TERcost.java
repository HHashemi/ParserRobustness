...
public class TERcost {
   ...
   * (inclusive).  If it isn't, then it will break TERcalc! */
	...
	// Huma: add setters to the class. 
	public void setMatch_cost(double cost){
		_match_cost = cost;
	}

	public void setSusbtitue_cost(double cost){
		_substitute_cost = cost;
	}
	
	public void setInsert_cost(double cost){
		_insert_cost = cost;
	}
	
	public void setDelete_cost(double cost){
		_delete_cost = cost;
	}
	
	public void setShift_cost(double cost){
		_shift_cost = cost;
	}
